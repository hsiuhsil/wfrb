...
if BURST:
    ...
    DATAROOT = "/scratch2/p/pen/hsiuhsil/burst_candidates/57180_1hr_0013/raw_data/"
    OUT_ROOT = '/scratch2/p/pen/hsiuhsil/burst_candidates/57180_1hr_0013'
    FILENAME = "guppi_57180_wigglez1hr_centre_0013_0001.fits"

    # Calibration source scans.
    SRCFILES = [
        "guppi_57180_3C48_0006_0001.fits",
        "guppi_57180_3C48_0007_0001.fits",
        "guppi_57180_3C48_0008_0001.fits",
        "guppi_57180_3C48_0009_0001.fits",
        ]

    # Hard code the phase of the noise cal, since I'm too lazy to write an algorithm
    # to find it.
    DATA_CAL_PHASE = 49
    SRC_CAL_PHASES = [28, 30, 16, 19]

    # The small time slice of data containing the burst.
    TSL = np.s_[34000:39500]
...
def reformat_raw_data():
    ...
    if BURST:
        data, time, freq, ra, dec, az, el = read_fits_data(hdulist, 175, 205)
    else:
...
def fit_basic():
    ...
    pars0 = [0.074, 2., 0.003, 2., 0.004, 0.001]
